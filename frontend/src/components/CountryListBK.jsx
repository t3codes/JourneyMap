...
const WorldMap = ({ countries, userCountries, onCountryClick, isCountryVisited }) => {
  ...
  // Nova função para verificar se o país está em userCountries
  const isCountryInUserList = (countryName) => {
    return userCountries.some(country => country.nome_comum === countryName);
  };
              ...
              <Popup className="custom-popup">
                <div className="p-2 min-w-[200px]">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    {!isCountryInUserList(country.nome_comum) && (
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
